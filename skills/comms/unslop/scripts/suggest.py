...
Usage after setting UNSLOP_DIR:
    python3 "$UNSLOP_DIR/scripts/suggest.py" document.md
    python3 "$UNSLOP_DIR/scripts/suggest.py" < document.md
    python3 "$UNSLOP_DIR/scripts/suggest.py" document.md --apply-replacements replacements.json
"""
...
def main(argv: list[str]) -> int:
    ...
    if args.apply_replacements:
        try:
            ...
            print(f"Could not apply replacements: {exc}", file=sys.stderr)
            return 2
