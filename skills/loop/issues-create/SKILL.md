---
name: issues-create
description: Use when breaking a plan or spec into independently-grabbable GitHub issues as vertical-slice tracer bullets. Each issue is a thin end-to-end slice verified on its own.
